...
describe('DownloadButton', () => {
  ...
  it('should be disabled when explicitly disabled', () => {
    render(<DownloadButton blob={mockBlob} disabled={true} />);
  ...
  it('should hide download icon when showIcon is false', () => {
    render(<DownloadButton blob={mockBlob} showIcon={false} />);
  ...
  it('should show downloading state during download', async () => {
    ...
    mockService.triggerDownload = vi.fn().mockImplementation(() => 
  ...
  it('should handle download errors', async () => {
    ...
    const mockService = new DownloadService();
    mockService.triggerDownload = vi.fn().mockRejectedValue(
      new DownloadError('Download failed', 'TRIGGER_FAILED')
    );
