...
import { SlideLayout, PresentationTheme } from '../../src/models';
// Mock pptxgenjs
vi.mock('pptxgenjs', () => {
...
describe('PptxGenerator', () => {
    ...
    describe('addListElement', () => {
        it('should add an unordered list element', () => {
            ...
            expect(slide.addText).toHaveBeenCalledWith(['Item 1', 'Item 2', 'Item 3'], expect.objectContaining({
...
//# sourceMappingURL=PptxGenerator.test.js.map