...
describe('SectionSplittingConfig Component', () => {
    it('renders with the initial strategy selected', () => {
        ...
        render(_jsx(SectionSplittingConfig, { initialStrategy: SplitStrategy.BY_H1, onChange: onChange }));
    ...
    it('calls onChange with custom selector when input changes', () => {
        const onChange = vi.fn();
        render(_jsx(SectionSplittingConfig, { initialStrategy: SplitStrategy.BY_CUSTOM_SELECTOR, initialCustomSelector: "", onChange: onChange }));
...
//# sourceMappingURL=SectionSplittingConfig.test.js.map