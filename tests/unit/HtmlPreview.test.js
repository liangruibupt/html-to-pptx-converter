...
describe('HtmlPreview Component', () => {
    ...
    test('renders the HTML preview component', () => {
        render(_jsx(HtmlPreview, { htmlContent: "<p>Test content</p>" }));
