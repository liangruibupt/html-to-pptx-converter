...
describe('ThemeHandler', () => {
    ...
    describe('applyTheme', () => {
        it('should apply the professional theme to a presentation', () => {
            ...
            expect(mockPresentation.theme).toEqual(expect.objectContaining({
                title: 'PROFESSIONAL',
                headingColor: '0F3C5F',
                bodyColor: '333333',
    ...
    describe('getThemeColorPalette', () => {
        it('should return color palette for the professional theme', () => {
            ...
            expect(colorPalette).toEqual(expect.objectContaining({
                heading: '0F3C5F',
                subheading: '2E75B6',
                body: '333333',
                background: 'FFFFFF'
...
//# sourceMappingURL=ThemeHandler.test.js.map